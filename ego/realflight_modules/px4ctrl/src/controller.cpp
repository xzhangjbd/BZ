...
//      printf("%6.3f,%6.3f,%6.3f,%6.3f\n", des_acc(2), des.a(2), des.v(2), des.p(2));
...
/*  ROS_INFO("Desired acceleration: [%f, %f, %f]", des_acc(0), des_acc(1), des_acc(2));
  ROS_INFO("Thrust: %f", u.thrust);
  ROS_INFO("Orientation (quaternion): [%f, %f, %f, %f]", u.q.x(), u.q.y(), u.q.z(), u.q.w());
*/
  /* WRITE YOUR CODE HERE */
    ...
    const Parameter_t &param)
{
  ...
  while (timed_thrust_.size() >= 1)
  {
    ...
    //printf("%6.3f,%6.3f,%6.3f,%6.3f\n", thr2acc_, gamma, K, P_);
    //fflush(stdout);
  /*  ROS_INFO("Thrust-to-acceleration mapping updated: %6.3f", thr2acc_);
    ROS_DEBUG("Gamma: %6.3f, K: %6.3f, P: %6.3f", gamma, K, P_);
*/    
